...
{'Feynman61': {'EquationName': 'Feynman61', 'DescriptiveName': 'Feynman61, Lecture II.11.3', 'Formula_Str': 'q*Ef/(m*(omega_0**2-omega**2))', 'Formula': 'q*Ef/(m*(omega_0**2-omega**2))', 'Formula_Lambda': 'lambda args : (lambda q,Ef,m,omega_0,omega: q*Ef/(m*(omega_0**2-omega**2)) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda q,Ef,m,omega_0,omega: {0} )(*args)', 'Variables': [{'name': 'q', 'low': 1.0, 'high': 3.0}, {'name': 'Ef', 'low': 1.0, 'high': 3.0}, {'name': 'm', 'low': 1.0, 'high': 3.0}, {'name': 'omega_0', 'low': 3.0, 'high': 5.0}, {'name': 'omega', 'low': 1.0, 'high': 2.0}]}},
...
{'Feynman74': {'EquationName': 'Feynman74', 'DescriptiveName': 'Feynman74, Lecture II.27.18', 'Formula_Str': 'epsilon*Ef**2', 'Formula': 'epsilon*Ef**2', 'Formula_Lambda': 'lambda args : (lambda epsilon,Ef: epsilon*Ef**2 )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda epsilon,Ef: {0} )(*args)', 'Variables': [{'name': 'epsilon', 'low': 1.0, 'high': 5.0}, {'name': 'Ef', 'low': 1.0, 'high': 5.0}]}},
{'Feynman75': {'EquationName': 'Feynman75', 'DescriptiveName': 'Feynman75, Lecture II.34.2a', 'Formula_Str': 'q*v/(2*pi*r)', 'Formula': 'q*v/(2*np.pi*r)', 'Formula_Lambda': 'lambda args : (lambda q,v,r: q*v/(2*np.pi*r) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda q,v,r: {0} )(*args)', 'Variables': [{'name': 'q', 'low': 1.0, 'high': 5.0}, {'name': 'v', 'low': 1.0, 'high': 5.0}, {'name': 'r', 'low': 1.0, 'high': 5.0}]}},
{'Feynman76': {'EquationName': 'Feynman76', 'DescriptiveName': 'Feynman76, Lecture II.34.2', 'Formula_Str': 'q*v*r/2', 'Formula': 'q*v*r/2', 'Formula_Lambda': 'lambda args : (lambda q,v,r: q*v*r/2 )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda q,v,r: {0} )(*args)', 'Variables': [{'name': 'q', 'low': 1.0, 'high': 5.0}, {'name': 'v', 'low': 1.0, 'high': 5.0}, {'name': 'r', 'low': 1.0, 'high': 5.0}]}},
{'Feynman77': {'EquationName': 'Feynman77', 'DescriptiveName': 'Feynman77, Lecture II.34.11', 'Formula_Str': 'g_*q*B/(2*m)', 'Formula': 'g_*q*B/(2*m)', 'Formula_Lambda': 'lambda args : (lambda g_,q,B,m: g_*q*B/(2*m) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda g_,q,B,m: {0} )(*args)', 'Variables': [{'name': 'g_', 'low': 1.0, 'high': 5.0}, {'name': 'q', 'low': 1.0, 'high': 5.0}, {'name': 'B', 'low': 1.0, 'high': 5.0}, {'name': 'm', 'low': 1.0, 'high': 5.0}]}},
{'Feynman78': {'EquationName': 'Feynman78', 'DescriptiveName': 'Feynman78, Lecture II.34.29a', 'Formula_Str': 'q*h/(4*pi*m)', 'Formula': 'q*h/(4*np.pi*m)', 'Formula_Lambda': 'lambda args : (lambda q,h,m: q*h/(4*np.pi*m) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda q,h,m: {0} )(*args)', 'Variables': [{'name': 'q', 'low': 1.0, 'high': 5.0}, {'name': 'h', 'low': 1.0, 'high': 5.0}, {'name': 'm', 'low': 1.0, 'high': 5.0}]}},
{'Feynman79': {'EquationName': 'Feynman79', 'DescriptiveName': 'Feynman79, Lecture II.34.29b', 'Formula_Str': 'g_*mom*B*Jz/(h/(2*pi))', 'Formula': 'g_*mom*B*Jz/(h/(2*np.pi))', 'Formula_Lambda': 'lambda args : (lambda g_,h,Jz,mom,B: g_*mom*B*Jz/(h/(2*np.pi)) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda g_,h,Jz,mom,B: {0} )(*args)', 'Variables': [{'name': 'g_', 'low': 1.0, 'high': 5.0}, {'name': 'h', 'low': 1.0, 'high': 5.0}, {'name': 'Jz', 'low': 1.0, 'high': 5.0}, {'name': 'mom', 'low': 1.0, 'high': 5.0}, {'name': 'B', 'low': 1.0, 'high': 5.0}]}},
{'Feynman80': {'EquationName': 'Feynman80', 'DescriptiveName': 'Feynman80, Lecture II.35.18', 'Formula_Str': 'n_0/(exp(mom*B/(kb*T))+exp(-mom*B/(kb*T)))', 'Formula': 'n_0/(np.exp(mom*B/(kb*T))+np.exp(-mom*B/(kb*T)))', 'Formula_Lambda': 'lambda args : (lambda n_0,kb,T,mom,B: n_0/(np.exp(mom*B/(kb*T))+np.exp(-mom*B/(kb*T))) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda n_0,kb,T,mom,B: {0} )(*args)', 'Variables': [{'name': 'n_0', 'low': 1.0, 'high': 3.0}, {'name': 'kb', 'low': 1.0, 'high': 3.0}, {'name': 'T', 'low': 1.0, 'high': 3.0}, {'name': 'mom', 'low': 1.0, 'high': 3.0}, {'name': 'B', 'low': 1.0, 'high': 3.0}]}},
{'Feynman81': {'EquationName': 'Feynman81', 'DescriptiveName': 'Feynman81, Lecture II.35.21', 'Formula_Str': 'n_rho*mom*tanh(mom*B/(kb*T))', 'Formula': 'n_rho*mom*np.tanh(mom*B/(kb*T))', 'Formula_Lambda': 'lambda args : (lambda n_rho,mom,B,kb,T: n_rho*mom*np.tanh(mom*B/(kb*T)) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda n_rho,mom,B,kb,T: {0} )(*args)', 'Variables': [{'name': 'n_rho', 'low': 1.0, 'high': 5.0}, {'name': 'mom', 'low': 1.0, 'high': 5.0}, {'name': 'B', 'low': 1.0, 'high': 5.0}, {'name': 'kb', 'low': 1.0, 'high': 5.0}, {'name': 'T', 'low': 1.0, 'high': 5.0}]}},
{'Feynman82': {'EquationName': 'Feynman82', 'DescriptiveName': 'Feynman82, Lecture II.36.38', 'Formula_Str': 'mom*H/(kb*T)+(mom*alpha)/(epsilon*c**2*kb*T)*M', 'Formula': 'mom*H/(kb*T)+(mom*alpha)/(epsilon*c**2*kb*T)*M', 'Formula_Lambda': 'lambda args : (lambda mom,H,kb,T,alpha,epsilon,c,M: mom*H/(kb*T)+(mom*alpha)/(epsilon*c**2*kb*T)*M )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda mom,H,kb,T,alpha,epsilon,c,M: {0} )(*args)', 'Variables': [{'name': 'mom', 'low': 1.0, 'high': 3.0}, {'name': 'H', 'low': 1.0, 'high': 3.0}, {'name': 'kb', 'low': 1.0, 'high': 3.0}, {'name': 'T', 'low': 1.0, 'high': 3.0}, {'name': 'alpha', 'low': 1.0, 'high': 3.0}, {'name': 'epsilon', 'low': 1.0, 'high': 3.0}, {'name': 'c', 'low': 1.0, 'high': 3.0}, {'name': 'M', 'low': 1.0, 'high': 3.0}]}},
{'Feynman83': {'EquationName': 'Feynman83', 'DescriptiveName': 'Feynman83, Lecture II.37.1', 'Formula_Str': 'mom*(1+chi)*B', 'Formula': 'mom*(1+chi)*B', 'Formula_Lambda': 'lambda args : (lambda mom,B,chi: mom*(1+chi)*B )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda mom,B,chi: {0} )(*args)', 'Variables': [{'name': 'mom', 'low': 1.0, 'high': 5.0}, {'name': 'B', 'low': 1.0, 'high': 5.0}, {'name': 'chi', 'low': 1.0, 'high': 5.0}]}},
{'Feynman84': {'EquationName': 'Feynman84', 'DescriptiveName': 'Feynman84, Lecture II.38.3', 'Formula_Str': 'Y*A*x/d', 'Formula': 'Y*A*x/d', 'Formula_Lambda': 'lambda args : (lambda Y,A,d,x: Y*A*x/d )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda Y,A,d,x: {0} )(*args)', 'Variables': [{'name': 'Y', 'low': 1.0, 'high': 5.0}, {'name': 'A', 'low': 1.0, 'high': 5.0}, {'name': 'd', 'low': 1.0, 'high': 5.0}, {'name': 'x', 'low': 1.0, 'high': 5.0}]}},
{'Feynman85': {'EquationName': 'Feynman85', 'DescriptiveName': 'Feynman85, Lecture II.38.14', 'Formula_Str': 'Y/(2*(1+sigma))', 'Formula': 'Y/(2*(1+sigma))', 'Formula_Lambda': 'lambda args : (lambda Y,sigma: Y/(2*(1+sigma)) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda Y,sigma: {0} )(*args)', 'Variables': [{'name': 'Y', 'low': 1.0, 'high': 5.0}, {'name': 'sigma', 'low': 1.0, 'high': 5.0}]}},
{'Feynman86': {'EquationName': 'Feynman86', 'DescriptiveName': 'Feynman86, Lecture III.4.32', 'Formula_Str': '1/(exp((h/(2*pi))*omega/(kb*T))-1)', 'Formula': '1/(np.exp((h/(2*np.pi))*omega/(kb*T))-1)', 'Formula_Lambda': 'lambda args : (lambda h,omega,kb,T: 1/(np.exp((h/(2*np.pi))*omega/(kb*T))-1) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda h,omega,kb,T: {0} )(*args)', 'Variables': [{'name': 'h', 'low': 1.0, 'high': 5.0}, {'name': 'omega', 'low': 1.0, 'high': 5.0}, {'name': 'kb', 'low': 1.0, 'high': 5.0}, {'name': 'T', 'low': 1.0, 'high': 5.0}]}},
{'Feynman87': {'EquationName': 'Feynman87', 'DescriptiveName': 'Feynman87, Lecture III.4.33', 'Formula_Str': '(h/(2*pi))*omega/(exp((h/(2*pi))*omega/(kb*T))-1)', 'Formula': '(h/(2*np.pi))*omega/(np.exp((h/(2*np.pi))*omega/(kb*T))-1)', 'Formula_Lambda': 'lambda args : (lambda h,omega,kb,T: (h/(2*np.pi))*omega/(np.exp((h/(2*np.pi))*omega/(kb*T))-1) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda h,omega,kb,T: {0} )(*args)', 'Variables': [{'name': 'h', 'low': 1.0, 'high': 5.0}, {'name': 'omega', 'low': 1.0, 'high': 5.0}, {'name': 'kb', 'low': 1.0, 'high': 5.0}, {'name': 'T', 'low': 1.0, 'high': 5.0}]}},
{'Feynman88': {'EquationName': 'Feynman88', 'DescriptiveName': 'Feynman88, Lecture III.7.38', 'Formula_Str': '2*mom*B/(h/(2*pi))', 'Formula': '2*mom*B/(h/(2*np.pi))', 'Formula_Lambda': 'lambda args : (lambda mom,B,h: 2*mom*B/(h/(2*np.pi)) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda mom,B,h: {0} )(*args)', 'Variables': [{'name': 'mom', 'low': 1.0, 'high': 5.0}, {'name': 'B', 'low': 1.0, 'high': 5.0}, {'name': 'h', 'low': 1.0, 'high': 5.0}]}},
