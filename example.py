...
plt.savefig('docs/fig/pairplot.png')
...
plt.savefig('docs/fig/lineplot1.png')
...
for col in list(df_noNoise.columns):
  sns.lineplot(data = df_noNoise, x=x, y=col, label = col, alpha=0.7 )
plt.savefig('docs/fig/lineplot2.png')
...
plt.savefig('docs/fig/pairplot_noisy.png')
...
plt.savefig('docs/fig/lineplot1_noisy.png')
...
for col in list(df_noise.columns):
  sns.lineplot(data = df_noise, x=x, y=col, label = col, alpha=0.7 )
plt.savefig('docs/fig/lineplot2_noisy.png')